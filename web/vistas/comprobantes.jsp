                        ...
                        <div class="content-wrapper">    
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="comprobantes?accion=nu" class="btn btn-success">
                                                <i class="fa fa-plus"></i> Nuevo Comprobante</a>                                              
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box">    
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive" >                 
                                            ...
                                            <table class="table table-bordered table-striped dataTable table-hover" id="TablaComprobantes" class="display">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Documento</th>
                                                ...
                                                <c:forEach var="compr" items="${comprobantes}" varStatus="iteracion"  >                                                   
                                                    <tr>
                                                        <td>${iteracion.index + 1}</td>
                                                        <td>${compr.nombre}</td>

                                                        <td><a href="<c:url value="comprobantes">
                                                                   <c:param name="accion" value="pr" />
                                                                   <c:param name="cod" value="${compr.codigo}" />
                                                               </c:url>"><button class="btn btn-warning" data-toggle="tooltip" title="" data-original-title="Editar">
                                                                    <i class="fa fa-pencil"></i></button></a>

                                                            <input type="hidden" id="codigo" value="${compr.codigo}">
                                                            <a id="deleteComprob" href="<c:url value="comprobantes">
                            ...
                            <section class="content">
                                ...
                                <div class="box">    
                                    ...
                                    <div class="box-header with-border">             
                                        <h3 class="box-title">Documentos de Identificación</h3>
                                    </div>
                                    <div class="box-body">
                                        <div class="table-responsive" >                                 
                                            <table class="table table-bordered table-striped dataTable table-hover" id="TablaDocumentos" class="display" >
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Documento</th>
                                                ...
                                                <c:forEach var="doc" items="${documento}" varStatus="iteracion"  >                                                   
                                                    <tr>
                                                        <td>${iteracion.index + 1}</td>
                                                        <td>${doc.nombre}</td>

                                                        <td><a href="<c:url value="comprobantes">
                                                                   <c:param name="accion" value="prDoc" />
                                                                   <c:param name="cod" value="${doc.codigo}" />
                                                               </c:url>"><button class="btn btn-warning" data-toggle="tooltip" title="Editar" data-original-title="Editar">
                                                                    <i class="fa fa-pencil"></i></button></a>

                                                            <input type="hidden" id="item2" value="${doc.codigo}">

                                                            <a  id="deleteDocumento" href="<c:url value="comprobantes">
                                                                    <c:param name="accion" value="eliminarDoc" />
                                                                    <c:param name="cod" value="${doc.codigo}" />
                                                                </c:url>"><button class="btn btn-danger" data-toggle="tooltip" title="Eliminar" data-original-title="Eliminar">
                                                                    <i class="fa fa-trash"></i></button></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="comprobantes?accion=nuevoDoc" class="btn btn-success">
