                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div class="content-wrapper">
                                ...
                                <section class="content">
                                    <div class="box">
                                        <form class="form-horizontal" action="comprobantes?accion=${accion}" method="post" onsubmit="return validarComprobante();">
                                            <input type="hidden" name="hCodigo" value="${comprobantes.codigo}">
                                            <div class="box-header with-border">
                                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Comprobante</h3>  
                                            </div>
                                            <div class="box-body">
                                                <div class="form-body">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input id="nomComprobante" type="text" class="form-control" placeholder="Ingrese el nombre del documento" name="txtNombre" 
                                                                       value="${comprobantes.nombre}">
                                                            </div>
