                                ...
                                <ul class="sidebar-menu" data-widget="tree">
                                    ...
                                    <li class="treeview">
                                        ...
                                        <ul class="treeview-menu menu-open" style="">
                                            ...
                                            <li class=""><a href="ControladorCompras?accion=ListarCompras" ><i class="fa fa-bar-chart"></i> Reporte de Compras</a></li></ul>
                                    </li>
                                    <li class="treeview">
                                        <a href="#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="Empleado?accion=nu" class="btn btn-success">
                                ...
                                <div class="box">    
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive" >                                 
                                            <table class="table table-bordered table-striped dataTable table-hover" id="Tablaempleado" class="display">
                                                ...
                                                <c:forEach var="empl" items="${lisEmpleado}" varStatus="iteracion"  >
                                                    <tr>
                                                        <td>${iteracion.index + 1}</td>
                                                        <td>${empl.getNombre()}</td>
                                                        <td>${empl.getApellidos()}</td>
                                                        <td>${empl.getDocumentoIdentidad().nombre}</td>
                                                        <td>${empl.getNumDocumento()}</td>
                                                        <td>${empl.getCelular()}</td>
                                                        <td>${empl.getNombreUsuario()}</td>
                                                        <td>${empl.getCargo().getDescripcion()}</td>
                                                        <c:if test="${empl.isVigencia() == true}">
                                                            <td>
                                                                <span class="badge bg-green active">ACTIVO</span></td> 
                                                            </c:if>
                                                            <c:if test="${empl.isVigencia() == false}">
                                                            <td>
                                                                <span class="badge bg-red active">INACTIVO</span></td> 
                                                            </c:if>
                                                        <td><a href="<c:url value="Empleado">
                                                                   <c:param name="accion" value="pr" />
                                                                   <c:param name="cod" value="${empl.getId_Empleados()}" />
                                                               </c:url>"><button class="btn btn-warning" data-toggle="tooltip" title="" data-original-title="Editar">
                                                                    <i class="fa fa-pencil"></i></button></a>
                                                                    <%--<c:choose>
                                                                        <c:when test="${empl.isVigencia() == true}">
                                                                    <input type="hidden" id="item" value="${empl.Id_Empleados}">

                                                                    <a id="desactivarEmpl" href="Empleado?cambiar=des&cod=${empl.Id_Empleados}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar">
                                                                        <i class="fa fa-trash"></i></a>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    <input type="hidden" id="item" value="${empl.Id_Empleados}">

                                                                    <a id="activarEmpl" href="Empleado?cambiar=act&cod=${empl.Id_Empleados}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
