                                                ...
                                                <div class="col-lg-12 left">
                                                    <div class="box-body">
                                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                            <div class="form-group">  
                                                                <label>E-mail:</label>
                                                                <input type="email" maxlength="50" name="txtCorreo"  placeholder="ejemplo@pielmorena.com" class="form-control" 
                                                ...
                                                <div class="col-lg-12 left">
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <label>Celular</label>
                                                                <input id="celular" type="text" maxlength="10" name="txtCelular" class="form-control" placeholder="9999999999" autofocus="" 
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" maxlength="100" name="txtDireccion"  class="form-control" placeholder="Fulgencio Yegros - Hernandarias" 
                                                                       value="${cliente.getDirección()}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
