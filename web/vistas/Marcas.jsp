                                ...
                                <ul class="sidebar-menu" data-widget="tree">
                                    ...
                                    <li class="treeview active">
                                        ...
                                        <ul class="treeview-menu">
                                            ...
                                            <li class="active"><a href="Marcas?accion=listar"><i class="fa fa-tags"></i> Marcas</a></li>
                                        </ul>
                                    </li>
                                ...
                                <div class="box">    
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive" >                                 
                                            <table class="table table-bordered table-striped dataTable table-hover" id="TablaMarcas" class="display">
                                                ...
                                                <c:forEach var="marc" items="${marca}" varStatus="iteracion"> 
                                                    <tr>
                                                        <td>${iteracion.index + 1}</td>
                                                        <td>${marc.nombre}</td>
                                                        <c:if test="${marc.vigencia == true}">
                                                            <td>
                                                                <span class="badge bg-green active">ACTIVO</span></td> 
                                                            </c:if>
                                                            <c:if test="${marc.vigencia == false}">
                                                            <td>
                                                                <span class="badge bg-red active">INACTIVO</span></td> 
                                                            </c:if>
                                                        <td><a href="<c:url value="Marcas">
                                                                   <c:param name="accion" value="pr" />
                                                                   <c:param name="cod" value="${marc.id_Marca}" />
                                                               </c:url>"><button class="btn btn-warning" data-toggle="tooltip" title="Editar" data-original-title="Editar">
                                                                    <i class="fa fa-pencil"></i> </button></a>
                                                                    <c:choose>
                                                                        <c:when test="${marc.isVigencia() == true}">
                                                                    <input type="hidden" id="id" value="${marc.id_Marca}">

                                                                    <a id="desactivarMarca" href="Marcas?cambiar=des&cod=${marc.id_Marca}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar"">
                                                                        <i class="fa fa-remove"></i></a>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    <input type="hidden" id="id" value="${marc.id_Marca}">
                                                                    <a id="activarMarca" href="Marcas?cambiar=act&cod=${marc.id_Marca}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
