                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10 col-md-5 ">
                                            <div class="btn-group pull-right">
                                                <a href="Categorias?accion=listar" class="btn btn-default">
                                ...
                                <section class="content">
                                    <div class="box">
                                        <div class="box-header with-border">
                                            <i class="fa fa-edit"></i> <h3 class="box-title"> Categorías</h3>  

                                        </div>
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                        <form class="form-horizontal" action="Categorias?accion=${accion}" method="post" onsubmit=" return validarCategoria();">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4 input-group">
                                                        ...
                                                        <input id="cat" type="text" class="form-control" placnombreeholder="Nombre de la Categoria" name="txtNombre" 
                                                               required="" value="${categoria.nombreCategoria}">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="chkVigencia" 
                                                                       <c:out value="${categoria.vigencia == false ?
                                                                                       'unchecked' : 'checked'}"
                                                                              default="" />>Activo
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Mostrar en Menú:</label>

                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="chkMostrar" 
                                                                       <c:out value="${categoria.mostrar == false ?
                                                                                       'unchecked' : 'checked'}"
                                                                              default="" />>Sí
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="box-footer">
                                                ...
                                                <button type="submit" id="btnCat" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Guardar</button></i>
