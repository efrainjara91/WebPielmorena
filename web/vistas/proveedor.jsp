                                ...
                                <ul class="sidebar-menu" data-widget="tree">
                                    ...
                                    <li class="treeview active">
                                        ...
                                        <ul class="treeview-menu">
                                            ...
                                            <li class="active"><a href="proveedor?accion=listar"><i class="fa fa-circle-o"></i> Proveedores</a></li>
                                        </ul>
                                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="proveedor?accion=nu" class="btn btn-success">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<c:url value="proveedor">
                                                                   ...
                                                                   <c:param name="cod" value="${prov.idProveedor}" />
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${prov.isEstado() == true}">
                                                                        <input type="hidden" id="item" value="${prov.idProveedor}">

                                                                        <a id="desactivarProv" href="proveedor?cambiar=des&cod=${prov.idProveedor}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar">
                                                                            <i class="fa fa-remove"></i></a>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                        <input type="hidden" id="item" value="${prov.idProveedor}">

                                                                        <a id="activarProv" href="proveedor?cambiar=act&cod=${prov.idProveedor}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
