                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="clientes?accion=nu" class="btn btn-success">
                                ...
                                <div class="box">    
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive" >                                 
                                            <table class="table table-bordered table-striped dataTable table-hover" id="clientes" class="display">
                                                ...
                                                <c:forEach var="cli" items="${cliente}" varStatus="iteracion"  >
                                                    <tr>
                                                        ...
                                                        <td>${cli.dirección}</td>
                                                        <%--<td>${cli.documentoIdentidad.nombre}</td>--%>
                                                        <td>${cli.numIdentificación}</td>
                                                        <td>${cli.correo_electrónico}</td>
                                                        <c:if test="${cli.celular != ''}">
                                                            <td> ${cli.celular} </td> 
                                                        </c:if>
                                                        <c:if test="${cli.celular == ''}">
                                                            <td> - </td> 
                                                        ...
                                                        <c:if test="${cli.estado == true}">
                                                            <td>
                                                                <span class="badge bg-green active">ACTIVO</span></td> 
                                                            </c:if>
                                                            <c:if test="${cli.estado == false}">
                                                            <td>
                                                                <span class="badge bg-red active">INACTIVO</span></td> 
                                                            </c:if>
                                                        <td><a href="<c:url value="clientes">
                                                                   <c:param name="accion" value="pr" />
                                                                   <c:param name="cod" value="${cli.idCliente}" />
                                                               </c:url>"><button class="btn btn-warning" data-toggle="tooltip" title="" data-original-title="Editar">
                                                                    <i class="fa fa-pencil"></i></button></a>
                                                                    <c:choose>
                                                                        <c:when test="${cli.isEstado() == true}">
                                                                    <input type="hidden" id="valor" value="${cli.idCliente}">

                                                                    <a id="desactivarCliente" href="clientes?cambiar=des&cod=${cli.idCliente}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar"">
                                                                        <i class="fa fa-remove"></i></a>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    <input type="hidden" id="valor" value="${cli.idCliente}">

                                                                    <a id="activarCliente" href="clientes?cambiar=act&cod=${cli.idCliente}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
