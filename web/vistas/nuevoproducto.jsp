                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div class="content-wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10 col-md-5 ">
                                            <div class="btn-group pull-right">
                                                <a href="productos?accion=listar" class="btn btn-default">
                                ...
                                <section class="content">
                                    <div class="box">
                                        <form class="form-horizontal" action="productos?accion=${accion}" method="post" enctype="multipart/form-data" onsubmit="return validarProducto();" >
                                            <input type="hidden" name="hCodigo" value="${producto.id_Producto}">
                                            <div class="box-header with-border">
                                                <i class="fa fa-edit"></i> <h3 class="box-title">Catálogo de Productos</h3>  
                                            </div>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-body">
                                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                        ...
                                                        <select class="form-control"  name="cboCategoria" autofocus=""  required="">
                                                    ...
                                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                        ...
                                                        <div class="form-group">
                                                            <select required="" class="form-control" name="cboMarca" >
                                                                <option value="">Seleccione una marca</option>
                                                                <c:forEach items="${marcas}" var="marc">
                                                                    <option value="${marc.id_Marca}"  
                                                                            <c:if test="${marc.id_Marca == 
                                                    ...
                                                    <div class="form-group">                        
                                                        ...
                                                        <div class="col-xs-6">
                                                            <label>Nombre:</label>
                                                            <input id="nomP" type="text" maxlength="50" required="" class="form-control" name="txtNombre"  placeholder="Ingrese el nombre del Producto" 
                                                                   value="${producto.nombre}">
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <label>Descripción:</label>

                                                            <input type="text" class="form-control " required="" name="txtDescripcion" placeholder="Ingrese color, talla,etc."
                                                    ...
                                                    <div class="form-group">   
                                                        <div class="col-xs-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input id="Descripcion" type="text" class="form-control" name="txtPrecioCompra"  required="" placeholder=""
                                                        ...
                                                        <div class="col-xs-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input  type="text" class="form-control" required="" name="txtPrecioVenta" placeholder=""
                                                                        value="${producto.precio}">
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left hidden">
                                                        <label>Stock :</label>
                                                        <div class="form-group">

                                                            <input type="hidden" class="form-control" name="stock" value="0" placeholder=""
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 left">
                                                            ...
                                                            <input id="imagen" type="file" class="form-control" name="txtFoto" />
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="chkVigencia" 
                                                                       <c:out value="${producto.vigencia == false ?
                                                                                       'unchecked' : 'checked'}"
                                                                              default="" />>Activo
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="chkDestacado" 
                                                                       <c:out value="${producto.destacado == false ?
                                                                                       'unchecked' : 'checked'}"
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left">
                                                    ...
                                                    <button type="submit" id="btnRegistrarPro" value="Registrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Guardar</button></i>
