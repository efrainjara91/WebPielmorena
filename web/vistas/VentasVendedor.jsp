                                ...
                                <ul class="sidebar-menu" data-widget="tree">
                                    ...
                                    <li class="treeview active">
                                        ...
                                        <ul class="treeview-menu">
                                            <li class="active"><a href="ControladorVentasVendedor?accion=NuevaVenta"><i class="fa fa-cart-plus"></i> Nueva Venta</a></li>
                                    ...
                                    <li class="treeview">
                                        ...
                                        <ul class="treeview-menu menu-open" style="">
                                            <li class=""><a href="ControladorVentasVendedor?accion=ListarVentas" ><i class="fa fa-bar-chart"></i> Reporte de Ventas</a></li>
                                        </ul>
                                    </li>
                                        ...
                                        <div class="mt-1 ml-4 mr-4">
                                            ...
                                            <div class="row cabecera">            
                                                <div class="form-group col-md-3">  
                                                    ...
                                                    <select class="form-control" name="cboCliente" id="cboCliente" required="">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" class="form-control text-center" style="height: 35px; font-size: 24px" name="txtSerie"  value="">
                                                </div>
                                                <div class="form-group col-md-3">
                                                            ...
                                                            <c:forEach var="det" items="${listaProductosBoleta}" varStatus="iteracion">
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center for" style="width: 5%">                                                                        
                                                                        <a href="ControladorVentasVendedor?accion=Delete&id=${det.id}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Eliminar</a>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                        </tbody>
                                                ...
                                                <div class="col-md-3">                    
                                                    <div class="card">                       
                                                        <div class="card-body">
                                                            ...
                                                            <br>
                                                            <a href="ControladorVentasVendedor?accion=GenerarVenta" class="btn btn-success btn-block">Generar</a>
                                                            <a href="ControladorVentasVendedor?accion=Cancelar" class=" btn btn-danger btn-block" >Cancelar</a>
                                                        </div>                        
                                                    </div>             
                                                </div>
                                            </div>
                        ...
                        <script>
                            $(document).ready(function () {
                                $("tr #Cantidad").click(function () {
                                    ...
                                    var url = "ControladorVentasVendedor?accion=ActualizarCantidad";
                                    var cantidad = $(this).parent().find("#Cantidad").val();
                                    $("tr #Cantidad").load(url, {"arreglo[]": [idp, cantidad]});
                                    location.href = "ControladorVentasVendedor?accion=Listar";
                                });
                            });
                        </script> 
                        <%
                        ...
                        <script>
                            ...
                            $(document).ready(function () {
                                ...
                                $('select#cboCliente').on('change', function () {
                                    ...
                                    var url = "ControladorVentasVendedor?accion=SeleccionarCliente";
                                    $.ajax({
                                        type: 'POST',
                                        url: url,
                                ...
                                $('select#cboDocumento').on('change', function () {
                                    ...
                                    var url = "ControladorVentasVendedor?accion=SeleccionarComprobante";
                                    $.ajax({
                                        type: 'POST',
                                        url: url,
