                                    ...
                                    <ul class="sidebar-menu" data-widget="tree">
                                        ...
                                        <li class="treeview">
                                            ...
                                            <ul class="treeview-menu menu-open" style="">
                                                <li class=""><a href="ControladorPrincipal?accion=DetalleReporte"><i class="fa fa-bar-chart"></i> Reporte de ventas</a></li>
                                                <li class=""><a href="ControladorCompras?accion=DetalleCompras"><i class="fa fa-bar-chart"></i> Reporte de inventario</a></li>
                                            </ul>
                                        </li>
                                        <li class="treeview">
                                            <a href="#">
                                            ...
                                            <ul class="treeview-menu">
                                                <li><a href="global?accion=listar"><i class="fa fa-circle-o"></i> General</a></li>
