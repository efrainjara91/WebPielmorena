                                ...
                                <ul class="sidebar-menu" data-widget="tree">
                                    ...
                                    <li class="treeview active">
                                        ...
                                        <ul class="treeview-menu">
                                            ...
                                            <li class="active"><a href="Categorias?accion=listar"><i class="fa fa-bookmark-o"></i> Categorias</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="Categorias?accion=nu" class="btn btn-success">
                                ...
                                <div class="box">    
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive" >                                 
                                            <table class="table table-bordered table-striped dataTable table-hover" id="TablaCategoria" class="display">
                                                <thead>
                                                    <tr>
                                                        <th>N°</th>
                                                        <th>Categoria</th>
                                                ...
                                                <c:forEach var="cat" items="${categorias}" varStatus="iteracion">                                                    
                                                    <tr>
                                                        ...
                                                        <c:if test="${cat.vigencia == true}">
                                                            <td><span class="badge bg-green active">ACTIVO</span></td> 
                                                        </c:if>
                                                        <c:if test="${cat.vigencia == false}">
                                                            <td><span class="badge bg-red active">INACTIVO</span></td> 
                                                        </c:if>

                                                        <c:if test="${cat.mostrar == true}">
                                                            <td><span class="badge bg-green active">SÍ</span></td> 
                                                        </c:if>
                                                        <c:if test="${cat.mostrar == false}">
                                                            <td><span class="badge bg-red active">NO</span></td> 
                                                        </c:if> 


                                                        <td><a href="<c:url value="Categorias">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${cat.isVigencia() == true}">
                                                                    <input type="hidden" id="item" value="${cat.codigo}">

                                                                    <a id="desactivarCate" href="Categorias?cambiar=des&cod=${cat.codigo}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar">
                                                                        <i class="fa fa-remove"></i></a>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    <input type="hidden" id="item" value="${cat.codigo}">

                                                                    <a id="activarCate" href="Categorias?cambiar=act&cod=${cat.codigo}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
