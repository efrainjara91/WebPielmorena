                                                        ...
                                                        <c:forEach var="venta" items="${ListaVentas}" varStatus="iteracion">                                                    
                                                            <tr class="text-center" style="font-size: 14px">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="<c:url value="ControladorPrincipal">
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${venta.isEstado() == true}">
                                                                            ...
                                                                            <a id="AnularVenta" href="ControladorPrincipal?cambiar=des&cod=${venta.idventa}" class="btn btn-danger"  data-toggle="tooltip" title="Anular Venta" data-original-title="Desactivar">
                                                                                <i class="fa fa-times-circle"></i></a>
                                                                            </c:when>
                                                                            <%--<c:otherwise>
                                                                            <input type="hidden" id="id" value="${venta.idventa}">
                                                                            <a id="" href="ControladorPrincipal?cambiar=act&cod=${venta.idventa}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
