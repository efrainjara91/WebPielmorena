                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 col-md-5 ">
                                        <div class="btn-group pull-right">
                                            <a href="cargos?accion=nu" class="btn btn-success">
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive" >                                 
                                            <table class="table table-bordered table-striped dataTable table-hover" id="TablaCargos" class="display">
                                                ...
                                                <c:forEach var="ca" items="${cargos}" varStatus="iteracion"  >
                                                    <tr>
                                                        <td>${iteracion.index + 1}</td>
                                                        <td>${ca.descripcion}</td>
                                                        <td>${ca.vigencia == false ? 'Inactivo' : 'Activo'}</td>
                                                        <td><a href="<c:url value="cargos">
                                                                   <c:param name="accion" value="pr" />
                                                                   <c:param name="cod" value="${ca.codigo}" />
