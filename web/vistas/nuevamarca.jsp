                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div class="content-wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10 col-md-5 ">
                                            <div class="btn-group pull-right">
                                                <a href="Marcas?accion=listar" class="btn btn-default">
                                ...
                                <section class="content">
                                    <div class="box">
                                        <form class="form-horizontal" action="Marcas?accion=${accion}" method="post" onsubmit="return validarMarca();">
                                            <input type="hidden" name="hCodigo" value="${marca.id_Marca}">
                                            <div class="box-header with-border">
                                                <i class="fa fa-edit"></i> <h3 class="box-title">Marca</h3>  
                                            </div>
                                            <div class="box-body">
                                                <div class="form-body">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input id="marc" type="text" class="form-control" placeholder="Nombre de marca" name="txtMarca"
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" name="chkVigencia" 
                                                                           <c:out value="${marca.vigencia == false ?
                                                                                           'unchecked' : 'checked'}"
                                                                                  default="" />>Activo
                                                                </label>
                                                            </div>
                                            ...
                                            <div class="box-footer">
                                                ...
                                                <button type="submit" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Guardar</button></i>
