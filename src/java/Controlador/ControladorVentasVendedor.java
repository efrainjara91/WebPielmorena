...
public class ControladorVentasVendedor extends HttpServlet {
        ...
        if (request.getParameter("accion") != null) {
            ...
            switch (accion) {
                case "NuevaVenta":
                    ...
                    request.getRequestDispatcher("vistas/VentasVendedor.jsp").forward(request, response);
                    break;
                case "ListarVentas":
                ...
                case "SeleccionarCliente":
                    ...
                    sesion.setAttribute("nomclie", cli);
                    NumeroSerieComprobate(request);
                    request.getRequestDispatcher("ControladorVentasVendedor?accion=Listar").forward(request, response);
                    break;
                ...
                case "GenerarVenta":
                    ...
                    if (totalPagar != 0) {
                        ...
                        request.getRequestDispatcher("ControladorVentasVendedor?accion=NuevaVenta").forward(request, response);
                    }
                ...
                case "ReporteVentas1":
                    ...
                    request.getRequestDispatcher("ControladorVentasVendedor?accion=DetalleReporte").forward(request, response);
                    break;
                case "ReporteVentas2":
                    try {
                ...
                case "ReporteVentas5":
                    ...
                    break;
                case "DetalleReporte":
                    request.getRequestDispatcher("/vistas/ListadeVentasVendedor.jsp").forward(request, response);
...
//        igv = subTotal * 0.18;
    ...
    private void listarVentas(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/ListadeVentasVendedor.jsp").forward(request, response);
        } catch (Exception e) {
